...
<page backtop="15mm" backbottom="15mm" backleft="15mm" backright="15mm" style="font-size: 12pt; font-family: arial" >
        ...
        <table class="page_footer">
            <tr>
                ...
                <td style="width: 50%; text-align: right">
                    &copy; <?php echo "Daynier SR. "; echo  $anio=date('Y'); ?>
                </td>
            </tr>
        </table>
    </page_footer>
    ...
    <table cellspacing="0" style="width: 100%; text-align: left; font-size: 11pt;">
        <tr>
           <td style="width:10%;" class='midnight-blue'>SUMINIS-<br>TRADOR</td>
		   <td style="width:100%;">
			<?php
			echo "<br> NOMBRE:";	
			echo "<br> Empresa de Fertilizantes y Plaguisidas";
			echo "<br> DIRECCION:";
			echo "<br> Carretera Temolectrica No. 12-B, Nuevitas, Camaguey, CP: 72510";
			?>
			</td>		
        </tr>
		<tr>
           <td style="width:10%;" class='midnight-blue'>CLIENTE</td>
		   <td style="width:100%;">
			<?php
			echo "<br> FACTURAR:EMP SUMINISTRO Y TRANSP AGROPEC. CAMAGUEY";	
			echo "<br> DIRECCION:CALLE 3RA ESQUINA 4TA REPARTO VISTA HERMOSA";
			echo "<br> MUNICIPIO: CAMAGUEY, PROVINCIA: CAMAGUEY";
			echo "<br> ENTREGAR EN: SANTA CRUZ/LA ROSA";
			?>
			</td>
        </tr>
    ...
    <table cellspacing="0" style="width: 100%; text-align: left; font-size: 10pt;">
        <tr>
            ...
            <th style="width: 60%;text-align:center" class='midnight-blue'>DESCRIPCION</th>
