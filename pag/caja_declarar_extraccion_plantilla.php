...
<blockquote>
  ...
  <p style='margin-left: 55px; margin-top: -35px;'>Clinica Tacna Medica Hope <br><b>Recibo de Extracci&oacute;n de efectivo en Caja</b></p>
</blockquote>

	<div class="normal">
		<p style="margin-top: 20px;"> Por medio de la presente se deja constancia que en la fecha <?php echo $fecha;?> se ha realizado una gesti&oacute;n de caja en la Cl&iacute;nica Tacna Medical Hope con los siguientes datos:</p>
		<br><br>
	  <table class="table">
		  <tr>
			  <td>Fecha:</td>
