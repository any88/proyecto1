        ...
        <div class="col-md-12">
          ...
          <div class="panel panel-default">
              <div class="panel-heading">
                  <b class="text-left"><i class="fa fa-search text-info"> NUEVO INSUMO</i></b>
                 
                    <div class="pull-right">
                        <a href='crearinsumo.php' class="btn btn-primary btn-xs" type="submit"> <i class="fa fa-plus"></i>Nuevo Insumo</a>
                   </div>
              </div>
                  ...
                  <table id="example" class="table table-striped table-hover display table-responsive " style="right: 10px;">
                    ...
                    <tbody>
                       ...
                       for ($i = 0; $i < count($list_insumos); $i++) 
                       {
                          ...
                          echo '<td>
                                   <a href="'.$link_edit.'?nik='.$list_insumos[$i]->getIdInsumo().'" title="Editar datos" class="btn btn-primary btn-xs"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a>

                                   <a href="'.$link_listar.'?action=delete&nik='.$list_insumos[$i]->getIdInsumo().'&v='.$list_insumos[$i]->getNombre().'" title="Eliminar" onclick="return confirm(\'Está seguro de borrar los datos '.$list_insumos[$i]->getNombre().' ?\')" class="btn btn-primary btn-xs"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a>
                           </td>';
                          echo "</tr>";
                       }
                       ?>
