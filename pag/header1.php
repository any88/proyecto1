...
<head>
  ...
  <link href="../lib/bootstrap/css/adminlte.min.css" rel="stylesheet">
    ...
    <div class="container">
      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu">
          ...
          <ul>
              <li><a href="crearservicio.php">Nuevo Servicio</a></li>
              <li><a href="addservicios.php">Add Servicio</a></li>
              <li><a href="#" onclick="Msg();">Listar Servicios</a></li>
           </ul>
          </li>
							...
							return {
								columns: [
									...
									},
									{
										alignment: 'right',
										fontSize: 13,
										text: 'Clínica Tacna Medical Hope'
									}
								],
								margin: 20
							}
							...
							return {
								columns: [
									...
									},
									{
										alignment: 'right',
										fontSize: 13,
										text: 'La mejor alternativa de salud en Tacna \nTelef: 980640044'
									}
								],
